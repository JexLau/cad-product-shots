...
See [MEDIA.md](./MEDIA.md) for the `media/` drop-in map. Case #1 ghost, three white-background stills, two studio stills, the orbit clip, and `media/og/share.jpg` are on the page. The live Demo · open CAD showcase is open headphones — featured track is dark-premium / DJI-bar (`08` featured + full `07`–`14`); soft-grey frames stay appendix-only. The e-ink watch case pack is under construction and is not shown as a qualified demo. Do not add stock or fake 3D.
